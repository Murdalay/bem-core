...
В `bem-core` реализован механизм двухэтапной шаблонизации данных. На первом этапе нормализованные данные, получаемые от бэкенда, преобразуются к view-ориентированному представлению.  Эту функцию выполняет шаблонизатор [BEMTREE](http://ru.bem.info/libs/bem-core/2.2.0/templates/bemtree/). 
...
На втором этапе ранее сформированный BEMJSON поэлементно преобразуется в HTML. Эту функцию выполняет шаблонизатор [BEMHTML](http://ru.bem.info/libs/bem-core/2.2.0/templates/reference). 
...
Входные данные шаблонизатора — БЭМ-дерево в формате [BEMJSON](http://ru.bem.info/libs/bem-core/2.2.0/templates/bemjson), описывающее веб-страницу.
...
* [Стандартные моды BEMHTML](http://ru.bem.info/libs/bem-core/2.2.0/templates/reference#standardmoda)
* [Стандартные моды BEMTREE](http://ru.bem.info/libs/bem-core/2.2.0/templates/bemtree#standardmoda)
...
* [Проверка подпредикатов в определенном порядке](http://ru.bem.info/libs/bem-core/2.2.0/templates/reference#check_predicate)
...
* [Наследование](http://ru.bem.info/libs/bem-core/2.2.0/templates/reference#inheritage)
* [Добавление БЭМ-сущностей для задач верстки](http://ru.bem.info/libs/bem-core/2.2.0/templates/reference#additionbem)
...
В ходе вычисления выражения `applyCtx` выполняются следующие шаги:
  ...
  1. Выставление [пустой моды](http://ru.bem.info/libs/bem-core/2.2.0/templates/reference#pustajamodaquotquot) в качестве текущей.
...
**См. также**:
  ...
  * [Оборачивание блока в другой блок](http://ru.bem.info/libs/bem-core/2.2.0/templates/reference#wrappingunit)
  * [Добавление БЭМ-сущностей для задач верстки](http://ru.bem.info/libs/bem-core/2.2.0/templates/reference#additionbem)
