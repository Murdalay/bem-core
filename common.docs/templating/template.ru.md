...
В `bem-core` реализован механизм двухэтапной шаблонизации данных. На первом этапе нормализованные данные, получаемые от бэкенда, преобразуются к view-ориентированному представлению.  Эту функцию выполняет шаблонизатор [BEMTREE](../bemtree/bemtree-reference.ru.md/). 
...
На втором этапе ранее сформированный BEMJSON поэлементно преобразуется в HTML. Эту функцию выполняет шаблонизатор [BEMHTML](../reference/reference.ru.md). 
...
Входные данные шаблонизатора — БЭМ-дерево в формате [BEMJSON](../bemjson/bemjson.ru.md), описывающее веб-страницу.
...
* [Стандартные моды BEMHTML](../reference/reference.ru.md#standardmoda)
* [Стандартные моды BEMTREE](../bemtree/bemtree-reference.ru.md#standardmoda)
...
* [Проверка подпредикатов в определенном порядке](../reference/reference.ru.md#check_predicate)
...
* [Наследование](../reference/reference.ru.md#inheritage)
* [Добавление БЭМ-сущностей для задач верстки](../reference/reference.ru.md#additionbem)
...
В ходе вычисления выражения `applyCtx` выполняются следующие шаги:
  ...
  1. Выставление [пустой моды](../reference/reference.ru.md#pustajamodaquotquot) в качестве текущей.
...
**См. также**:
  ...
  * [Оборачивание блока в другой блок](../reference/reference.ru.md#wrappingunit)
  * [Добавление БЭМ-сущностей для задач верстки](../reference/reference.ru.md#additionbem)
