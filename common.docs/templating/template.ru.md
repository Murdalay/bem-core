...
В `bem-core` реализован механизм двухэтапной шаблонизации данных. На первом этапе нормализованные данные, получаемые от бэкенда, преобразуются к view-ориентированному представлению.  Эту функцию выполняет шаблонизатор [BEMTREE](./common.docs/bemtree/bemtree-reference.ru.md/). 
...
На втором этапе ранее сформированный BEMJSON поэлементно преобразуется в HTML. Эту функцию выполняет шаблонизатор [BEMHTML](./common.docs/reference/reference.ru.md). 
...
![levels](./common.docs/templating/template-levels.png)
...
Входные данные шаблонизатора — БЭМ-дерево в формате [BEMJSON](./common.docs/bemjson/bemjson.ru.md), описывающее веб-страницу.
...
* [Стандартные моды BEMHTML](./common.docs/reference/reference.ru.md#standardmoda)
* [Стандартные моды BEMTREE](./common.docs/bemtree/bemtree-reference.ru.md#standardmoda)
...
* [Проверка подпредикатов в определенном порядке](./common.docs/reference/reference.ru.md#check_predicate)
...
* [Наследование](./common.docs/reference/reference.ru.md#inheritage)
* [Добавление БЭМ-сущностей для задач верстки](./common.docs/reference/reference.ru.md#additionbem)
...
В ходе вычисления выражения `applyCtx` выполняются следующие шаги:
  ...
  1. Выставление [пустой моды](./common.docs/reference/reference.ru.md#pustajamodaquotquot) в качестве текущей.
...
**См. также**:
  ...
  * [Оборачивание блока в другой блок](./common.docs/reference/reference.ru.md#wrappingunit)
  * [Добавление БЭМ-сущностей для задач верстки](./common.docs/reference/reference.ru.md#additionbem)
