...
В *i-bem.js* для добавления востребованной функиональности к блокам, используется специальный тип блоков – **блоки-миксы**. Главная особенность блоков-миксов состоит в том, что они не участвуют в цепочке наследования. Это позволяет примешивать, реализованную в них функциональность к блокам, без риска нарушения их связей с родительскими блоками (использование статических методов и т.д.).
