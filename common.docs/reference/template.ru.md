...
Шаблонизация наиболее востребована для:
* многостраничных БЭМ-проектов;
* проектов, предполагающих динамическую работу с данными, получаемыми от бэкенда.
...
###Особенности реализации шаблонизаторов BEMTREE и BEMHTML
...
* набор доступных для технологии стандартных мод;
* поля контекста;
* поведенияе конструкции `apply` и всех конструкций, использующих `apply`(`applyCtx` и т.д.)

TODO

xjst - beb-xjst - basic template - user template
