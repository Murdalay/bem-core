...
Базовый шаблон – это реализация блока `i-bem` в технологии  соответствующего шаблонизатора. Другими словами, для шаблонизатора BEMTREE базовым шаблоном является реализация блока `i-bem` в технологии BEMTREE – [i-bem.bemtree](https://github.com/bem/bem-core/blob/v1/common.blocks/i-bem/i-bem.bemtree). 
...
Можно выделить четыре уровня абстракции, каждый из которых реализует часть логики шаблонизатора:
1. XJST
2. BEM-XJST
3. Базовый шаблон
...
xjst - bem-xjst - basic template - user template
