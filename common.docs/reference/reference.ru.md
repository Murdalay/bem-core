...
данных может служить пример френдленты, разобранный в разделе [Приведение входных данных к формату, ориентированному на представление](http://ru.bem.info/libs/bem-core/2.1.0/bemtree/reference#bringing_input) документа по BEMTREE.
