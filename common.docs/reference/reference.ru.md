...
Подробнее об особенностях архитектуры BEMHTML читайте в разделе [архитектура шаблонизаторов BEMHTML и BEMTREE](./common.docs/templating/template.ru.md#uts_arch) документа по [шаблонизации данных в bem-core](./common.docs/templating/template.ru.md).

<a name="uts"></a>
####Поддержка BEM-XJST-синтаксиса
BEMHTML – [BEM-XJST-шаблонизатор](./common.docs/templating/template.ru.md#uts_intro). Иначе говоря, BEMHTML использует **BEM-XJST-синтаксис** и сохраняет все особенности BEM-XJST-шаблонизаторов, такие как:
...
HTML-дерева не требовалось изменять набор и порядок блоков и элементов. Приведение БЭМ-дерева к такому развернутому виду должно производиться на уровне бэкенда, предшествующего шаблонизатору (например, с помощью технологии [BEMTREE](./common.docs/bemtree/bemtree-reference.ru.md/)). 

Иллюстрацией view-ориентированного формата
данных может служить пример френдленты, разобранный в разделе [Приведение входных данных к формату, ориентированному на представление](./common.docs/bemtree/bemtree-reference.ru.md#bringing_input) документации по BEMTREE.
...
BEMHTML расширяет набор [контекстно-зависимых полей BEM-XJST](./common.docs/templating/template.ru.md#contextdependent) следующими:
<table>
<tr>
    <th>Поле</th>
    <th>Тип значения</th>
...
BEMHTML расширяет набор [контекстно-независимых полей BEM-XJST](./common.docs/templating/template.ru.md#context_independent) следующими:
