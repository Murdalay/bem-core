...
Подробнее об особенностях архитектуры BEMHTML читайте в разделе [архитектура шаблонизаторов BEMHTML и BEMTREE](http://ru.bem.info/libs/bem-core/2.2.0/templates/templates#uts_arch) документа по [шаблонизации данных в bem-core](http://ru.bem.info/libs/bem-core/2.2.0/templates/templates).

<a name="uts"></a>
####Поддержка BEM-XJST-синтаксиса
BEMHTML – [BEM-XJST-шаблонизатор](http://ru.bem.info/libs/bem-core/2.2.0/templates/templates#uts_intro). Иначе говоря, BEMHTML использует **BEM-XJST-синтаксис** и сохраняет все особенности BEM-XJST-шаблонизаторов, такие как:
...
HTML-дерева не требовалось изменять набор и порядок блоков и элементов. Приведение БЭМ-дерева к такому развернутому виду должно производиться на уровне бэкенда, предшествующего шаблонизатору (например, с помощью технологии [BEMTREE](http://ru.bem.info/libs/bem-core/2.2.0/templates/bemtree/)). 

Иллюстрацией view-ориентированного формата
данных может служить пример френдленты, разобранный в разделе [Приведение входных данных к формату, ориентированному на представление](http://ru.bem.info/libs/bem-core/2.2.0/templates/bemtree#bringing_input) документации по BEMTREE.
...
**См. также**:
  ...
  * [Синтаксис BEMJSON]((http://ru.bem.info/libs/bem-core/2.2.0/templates/bemjson)
...
* [Достраивание БЭМ-сущностей по контексту](http://ru.bem.info/libs/bem-core/2.2.0/templates/templates#extensionbem)
...
BEMHTML расширяет набор [контекстно-зависимых полей BEM-XJST](http://ru.bem.info/libs/bem-core/2.2.0/templates/templates#contextdependent) следующими:
<table>
<tr>
    <th>Поле</th>
    <th>Тип значения</th>
...
BEMHTML расширяет набор [контекстно-независимых полей BEM-XJST](http://ru.bem.info/libs/bem-core/2.2.0/templates/templates#context_independent) следующими:
...
**См. также**:
  ...
  * [Синтаксис шаблонов](http://ru.bem.info/libs/bem-core/2.2.0/templates/templates#template)
...
<a name="links"></a>
###Смотрите также
* [Примеры и рецепты BEMTREE](http://ru.bem.info/libs/bem-core/2.2.0/templates/bemtree#examples)
...
####В сообществе
* [BEMTREE](http://ru.bem.info/libs/bem-core/2.2.0/templates/bemtree/)
* [BEMJSON](http://ru.bem.info/libs/bem-core/2.2.0/templates/bemjson)
