...
БЭМ-дерево в формате BEMJSON является неотъемлемой частью механизмов [шаблонизации данных](../templating/template.ru.md), реализованных в `bem-core`. BEMJSON используется в качестве входных данных для шаблонизаторов:
* [BEMTREE](../bemtree/bemtree-reference.ru.md#inputdata);
* [BEMHTML](../reference/reference.ru.md#inputdata).
...
* [Сборка и подключение бандла технологий BEMTREE и BEMHTML](../templating/template.ru.md#polymorph)
...
Обратите внимание, что имена и смысл полей BEMJSON, управляющих HTML-представлением, совпадают с именами и смыслом соответствующих [стандартных мод](../reference/reference.ru.md#standardmoda) BEMHTML (тег, атрибуты, класс и т.п.). В случае, если какие-то из аспектов выходного HTML заданы **и во входных данных, и в BEMHTML-шаблонах**, то более высокий приоритет имеют значения, заданные в BEMHTML-шаблонах.
...
Пример использования данных из произвольного поля см. в разделе: [Выбор шаблона по условию](../reference/reference.ru.md#select_template) из документации по BEMHTML.
