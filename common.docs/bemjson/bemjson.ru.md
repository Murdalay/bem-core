...
БЭМ-дерево в формате BEMJSON является неотъемлемой частью механизмов [шаблонизации данных](./common.docs/templating/template.ru.md), реализованных в `bem-core`. BEMJSON используется в качестве входных данных для шаблонизаторов:
* [BEMTREE](./common.docs/bemtree/bemtree-reference.ru.md#inputdata);
* [BEMHTML](./common.docs/reference/reference.ru.md#inputdata).
...
* [Сборка и подключение бандла технологий BEMTREE и BEMHTML](./common.docs/templating/template.ru.md#polymorph)
...
* [Достраивание БЭМ-сущностей по контексту](./common.docs/templating/template.ru.md#extensionbem)
...
Обратите внимание, что имена и смысл полей BEMJSON, управляющих HTML-представлением, совпадают с именами и смыслом соответствующих [стандартных мод](./common.docs/reference/reference.ru.md#standardmoda) BEMHTML (тег, атрибуты, класс и т.п.). В случае, если какие-то из аспектов выходного HTML заданы **и во входных данных, и в BEMHTML-шаблонах**, то более высокий приоритет имеют значения, заданные в BEMHTML-шаблонах.
...
Пример использования данных из произвольного поля см. в разделе: [Выбор шаблона по условию](./common.docs/reference/reference.ru.md#select_template) из документации по BEMHTML.
